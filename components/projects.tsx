            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden border-b border-border">
                ...
                <div className="absolute left-4 top-4 flex gap-2">
                  <span className="rounded-full bg-background/90 px-3 py-1 font-mono text-xs text-foreground backdrop-blur-sm">
                    0{index + 1}
                  </span>
                  <span className={`rounded-full px-3 py-1 font-mono text-xs font-medium backdrop-blur-sm ${
              ...
              <div className="flex flex-1 flex-col p-6 md:p-7">
                ...
                {project.company && (
                  <p className="mt-1 text-xs font-medium text-primary uppercase tracking-wide">{project.company}</p>
                )}
                {project.school && (
                  <p className="mt-1 text-xs font-medium text-secondary-foreground uppercase tracking-wide">{project.school}</p>
                )}
                ...
                <div className="mt-6 flex items-center gap-5 border-t border-border pt-5">
                  <a href={project.demo} className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:opacity-80">
                    <ExternalLink className="h-4 w-4" />
                    Démo
                  </a>
                  <a href={project.repo} className="inline-flex items-center gap-2 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground">
